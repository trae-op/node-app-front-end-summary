...
!function(){"use strict";function e(e,t,r,n){n.checkAuthorization()&&(e.defaults.headers.common.Authorization=r.Authorization)}e.$inject=["$http","$log","$localStorage","mainAuthorizationService"],angular.module("app",["ngRoute","ngSanitize","ngStorage","facebook","header","home","front","page","shared"]).run(e)}(),function(){"use strict";function e(e,t){t.init("184315939079210"),e.otherwise({template:"<h1>None</h1><p>Nothing has been selected</p>"})}e.$inject=["$routeProvider","FacebookProvider"],angular.module("app").config(e)}(),function(){"use strict";angular.module("front",["ngRoute"])}(),function(){"use strict";function e(e){e.when("/resume/:id",{templateUrl:"parts/front/front.html",controller:"frontController",controllerAs:"$ctrl"})}e.$inject=["$routeProvider"],angular.module("front").config(e)}(),function(){"use strict";angular.module("header",[])}(),function(){"use strict";angular.module("home",["ngRoute"])}(),function(){"use strict";function e(e){e.when("/",{templateUrl:"parts/home/home.html",controller:"homeController",controllerAs:"$ctrl"})}e.$inject=["$routeProvider"],angular.module("home").config(e)}(),function(){"use strict";angular.module("page",["ngRoute"])}(),function(){"use strict";function e(e){e.when("/page/:id/:pageName/:pageNumber",{templateUrl:"parts/page/page.html",controller:"pageController",controllerAs:"$ctrl"})}e.$inject=["$routeProvider"],angular.module("page").config(e)}(),function(){"use strict";angular.module("shared",["ngRoute","ui.bootstrap"])}(),function(){"use strict";angular.module("users",[])}(),function(){"use strict";function e(e,t,r,n,a,i,o){var c=this;c.routeParams=t,n.getById("headers",c.routeParams.id,function(e){c.header=e[0]}),c.Authorization=function(){return o.checkAuthorization()},c.getUser=function(){return o.getUser()},c.update=function(){i.forms({title:"Update",fields:[{type:"text",placeholder:"position",name:"position",text:c.header.position,required:!0},{type:"text",placeholder:"age",name:"age",text:c.header.age,required:!0}]},function(e){var t=a.filledData(e);t.name=c.getUser().name,t._id=c.header._id,t.creator_email=c.header.creator_email,t.skills=c.header.skills,n.update("headers",t,function(e){c.header=e})})}}e.$inject=["$scope","$routeParams","$log","mainHttpService","frontService","popupsService","mainAuthorizationService"],angular.module("front").controller("frontController",e)}(),function(){"use strict";function e(e){var t=this;t.filledData=function(e){var t=function(t){return _.find(e,{name:t})};return{position:t("position").text,age:t("age").text}}}e.$inject=["$log"],angular.module("front").service("frontService",e)}(),function(){"use strict";function e(e,t,r,n,a,i){return{restrict:"EA",templateUrl:"../../../../parts/header/header.html",link:function(t,i,o){var c=function(e,t){return _.find(e,{name:t})};t.fbLoggedIn=!1,t.user={},t.login={},t.fbLogin=function(){n.get("bell/door",function(t){e.info("fb-->\n",t)})},t.logout=function(){n.logout()},t.getUser=function(){return a.getUser()},t.showTopMenu=function(){t.openTopMenu?t.openTopMenu=!1:t.openTopMenu=!0},t.authorization=function(){return a.checkAuthorization()},t.open=function(){r.forms({title:"Log In",fields:[{type:"email",placeholder:"email",text:"",name:"email",required:!0},{type:"password",placeholder:"password",text:"",name:"password",required:!0},{type:"checkbox",placeholder:"Remember me",name:"rememberMe",checked:!1}]},function(e){var r={email:c(e,"email").text,password:c(e,"password").text,rememberMe:c(e,"rememberMe").checked};n.login("users/login",r,function(e){t.openTopMenu=!1})})},t.registration=function(){r.forms({title:"Registration",fields:[{type:"text",placeholder:"name",text:"",name:"name",required:!0},{type:"number",placeholder:"Age",text:"",name:"age",required:!0},{type:"text",placeholder:"Resume Header",text:"",name:"position",required:!0},{type:"email",placeholder:"email",text:"",name:"email",required:!0},{type:"password",placeholder:"password",text:"",name:"password",required:!0},{type:"password",placeholder:"confirm password",text:"",name:"confirm_password",required:!0}]},function(e){var t={name:c(e,"name").text,email:c(e,"email").text,password:c(e,"password").text},r={email:c(e,"email").text,password:c(e,"password").text,rememberMe:!0},a={name:c(e,"name").text,age:c(e,"age").text,position:c(e,"position").text,skills:[],creator_email:c(e,"email").text};n.add("users",t,function(){n.login("users/login",r,function(e){n.add("headers",a,function(e){})})})})}}}}e.$inject=["$log","$routeParams","popupsService","mainHttpService","mainAuthorizationService","Facebook"],angular.module("header").directive("headerTop",e)}(),function(){"use strict";function e(e,t){}e.$inject=["$http","$log"],angular.module("header").service("headersService",e)}(),function(){"use strict";function e(e,t,r,n,a,i,o){var c=this;c.headers=[],n.get("headers",function(e){c.headers=e})}e.$inject=["$scope","$log","$routeParams","mainHttpService","popupsService","homeService","mainAuthorizationService"],angular.module("home").controller("homeController",e)}(),function(){"use strict";function e(e,t,r){}e.$inject=["$http","$log","$routeParams"],angular.module("home").service("homeService",e)}(),function(){"use strict";function e(e,t,r,n,a,i,o,c){var u=this;u.routeParams=t,n.getById("headers",u.routeParams.id,function(t){i.creatorEmail=t[0].creator_email,n.getByEmail(u.routeParams.pageName,t[0].creator_email,function(t){var r=_.reverse(t);u.items=r,e.prevItems=r})}),u.getCreatorEmailByHeader=function(){return i.creatorEmail},u.Authorization=function(){return c.checkAuthorization()},u.getUser=function(){return c.getUser()},u.add=function(){u.items||(u.items=[]),a.forms({title:"abouts"!==u.routeParams.pageName?"Add":"Create",fields:i.getFields()},function(t){n.add(u.routeParams.pageName,i.filledData(t),function(t){u.items.unshift(t),e.prevItems.unshift(t)})})},u.update=function(e,t){a.forms({title:"Update",fields:i.getFields(e)},function(r){var a=i.filledData(r);a._id=e._id,n.update(u.routeParams.pageName,a,function(e){u.items[t]=e})})},u["delete"]=function(t,r){n.deleteById(u.routeParams.pageName,t,function(t){u.items.splice(r,1),e.prevItems.splice(r,1)})},u.changeTitle=function(){return{allSymbols:function(){return _.capitalize(u.routeParams.pageName)},cutLastSymbol:function(){return this.allSymbols().substr(0,this.allSymbols().length-1)}}},u.loadScript=function(e){i.loadScript({title:"Load Script",data:e})}}e.$inject=["$scope","$routeParams","$log","mainHttpService","popupsService","pageService","paginationService","mainAuthorizationService"],angular.module("page").controller("pageController",e)}(),function(){"use strict";angular.module("page").directive("bindHtmlWithJs",["$sce","$parse",function(e,t){function r(e){e="<i></i>"+e;var t=angular.element(e),r=angular.element("<div></div>");if(t.length)for(var a=1,i=t.length;a<i;a++){var o=t.eq(a),c=o[0];"SCRIPT"!=c.nodeName||c.type&&"text/javascript"!=c.type?r.append(o):n(o[0])}return e=r.html()}function n(e){var t=document.createElement("script"),r=document.body,n=function(){t.onload=t.onerror=null,r.removeChild(t)};if(t.type="text/javascript",e.src)t.src=e.src,t.async=e.async,t.onload=t.onerror=function(){n()};else{try{t.appendChild(document.createTextNode(e.innerText))}catch(a){t.text=e.innerText}setTimeout(function(){n()},10)}r.appendChild(t)}return function(n,a,i){function o(){return(c(n)||"").toString()}a.addClass("ng-binding").data("$binding",i.bindHtmlWithJs);var c=t(i.bindHtmlWithJs);n.$watch(o,function(t){var i=t?e.getTrustedHtml(c(n)):"";i&&(i=r(i)),a.html(i||"")})}}])}(),function(){"use strict";angular.module("page").filter("htmlCode",["$sce",function(e){return function(t){return e.trustAsHtml(t)}}])}(),function(){"use strict";function e(e,t,r,n){var a=this;a.creatorEmail="",a.filledData=function(e){var t=function(t){return _.find(e,{placeholder:t})},n=function(){return{title:t("title").text,link:t("link").text,image:t("image").text,description:t("description").text,creator_email:a.creatorEmail}};switch(r.pageName){case"abouts":return{description:t("description").text,creator_email:a.creatorEmail};case"scripts":return{title:t("title").text,link:t("link").text,image:t("image").text,description:t("description").text,css:t("css").text,html:t("html").text,creator_email:a.creatorEmail};case"projects":return n();case"companies":return n();default:return{}}},a.getFields=function(e){var t=function(t){return e?e[t]:""},n=[{type:"text",placeholder:"title",text:t("title"),required:!0},{type:"text",placeholder:"link",text:t("link"),required:!0},{type:"text",placeholder:"image",text:t("image"),required:!0},{type:"textarea",placeholder:"description",text:t("description"),required:!0}];switch(r.pageName){case"scripts":return[{type:"text",placeholder:"title",text:t("title"),required:!0},{type:"text",placeholder:"image",text:t("image"),required:!0},{type:"textarea",placeholder:"description",text:t("description"),required:!0},{type:"textarea",placeholder:"css",text:t("css"),required:!0},{type:"textarea",placeholder:"link",text:t("link"),required:!0},{type:"textarea",placeholder:"html",text:t("html"),required:!0}];case"abouts":return[{type:"textarea",placeholder:"description",text:t("description"),required:!0}];case"projects":return n;case"companies":return n;default:return[]}},a.loadScript=function(e){n.open({ariaLabelledBy:"modal-title",ariaDescribedBy:"modal-body",templateUrl:"parts/load-script/load.script.html",controller:["$uibModalInstance","items",function(e,t){var r=this;r.title=t.title,r.script={css:t.data.css,html:t.data.html,js:t.data.link},r.close=function(){e.dismiss("close")}}],controllerAs:"$ctrl",size:"md",resolve:{items:function(){return e}}})}}e.$inject=["$http","$log","$routeParams","$uibModal"],angular.module("page").service("pageService",e)}(),function(){"use strict";function e(e,t,r){var n=this;n.firstOnlyLocalStorage={Authorization:void 0,user:void 0},n.checkRememberMe=function(e){r.checkRememberMe=e},n.checkAuthorization=function(){var e=!r.checkRememberMe,t=n.firstOnlyLocalStorage.Authorization,a=r.Authorization,i=e?t:a;return!!i},n.addAuthHeaderForAPI=function(t){r.Authorization="Bearer "+t,n.firstOnlyLocalStorage.Authorization="Bearer "+t,e.defaults.headers.common.Authorization="Bearer "+t,e.defaults.headers.common["Content-Type"]="application/json"},n.clearAuthHeaderForAPI=function(){r.Authorization=void 0,n.firstOnlyLocalStorage.Authorization=void 0,delete e.defaults.headers.common.Authorization},n.setToken=function(e){e&&(r.Authorization=e,n.firstOnlyLocalStorage.Authorization=e)},n.clearUserMyself=function(){n.firstOnlyLocalStorage.user=void 0,r.user=void 0},n.getUser=function(){return r.checkRememberMe?r.user:n.firstOnlyLocalStorage.user},n.setUserMyself=function(e){delete e.password,r.user=e,n.firstOnlyLocalStorage.user=e}}e.$inject=["$http","$log","$localStorage"],angular.module("shared").service("mainAuthorizationService",e)}(),function(){"use strict";function e(e,t,r,n){function a(e,t){return _.findIndex(s.cacheData[e],t)}function i(e,t,r){return _.filter(r,JSON.parse('{"'+t+'":"'+e+'"}'))}function o(){return window.API_URL+"/"}function c(t,r,n){e[t].apply(this,r).then(n)["catch"](u)}function u(e){e.data?r.messages("error",e):r.messages("error",{data:{message:"status: "+e.status}})}var s=this,l=!1;s.cacheData={},s.get=function(e,t){s.cacheData[e]?t(s.cacheData[e]):c("get",[o()+e],function(r){s.cacheData[e]=r.data,t(r.data)})},s.add=function(e,r,n){t.info("_this.cacheData",s.cacheData),c("post",[o()+e,r],function(t){"users"!==e&&s.cacheData[e].push(t.data),n(t.data)})},s.login=function(e,t,r){l&&(s.cacheData=l),n.checkRememberMe(t.rememberMe),delete t.rememberMe,c("post",[o()+e,t],function(e){n.setToken(e.data.token),n.addAuthHeaderForAPI(e.data.token),n.setUserMyself(e.data.user),r(e)})},s.logout=function(){l=s.cacheData,s.cacheData={},n.clearUserMyself(),n.setToken(),n.clearAuthHeaderForAPI()},s.update=function(e,t,r){c("put",[o()+e,t],function(t){s.cacheData[e][a(e,{_id:t.data._id})]=t.data,r(t.data)})},s.deleteById=function(e,t,r){c("delete",[o()+e+"/"+t],function(n){s.cacheData[e].splice(a(e,{_id:t}),1),r(n.data)})},s.getById=function(e,t,r){s.get(e,function(e){r(i(t,"_id",e))})},s.getByEmail=function(e,t,r){s.get(e,function(e){r(i(t,"creator_email",e))})}}e.$inject=["$http","$log","popupsService","mainAuthorizationService"],angular.module("shared").service("mainHttpService",e)}(),function(){"use strict";function e(e,t,r,n){return{restrict:"EA",templateUrl:"../../../../parts/pagination/pagination.html",link:function(e,n,a){e.routeParams=t;var i=Number(e.routeParams.pageNumber);e.$watch("prevItems",function(t){if(t){var n=r.group(t,3);e.pagination=n,e.$ctrl.items=n[Number(e.routeParams.pageNumber)-1]}},!0),e.showNumbering=function(e){var t=i===e+3,r=i===e+2,n=i===e+1,a=i===e,o=i===e-1;return t||r||n||a||o},e.showDots=function(e){return i===e+4||i===e-2},e.nextPage=function(){return Number(e.routeParams.pageNumber)+1},e.prevPage=function(){return Number(e.routeParams.pageNumber)-1}}}}e.$inject=["$log","$routeParams","paginationService","$timeout"],angular.module("shared").directive("pagination",e)}(),function(){"use strict";function e(e,t,r){var n,a=this;a.group=function(e,t){var r="",a=Math.ceil(e.length/t);n=e;for(var i=0;i<a;i+=1)r+="[]"+(a-1!==i?",":"");for(var o=JSON.parse("["+r+"]"),c=0;c<o.length;c+=1)o[c]=e.slice(c*t,c*t+t);return o}}e.$inject=["$http","$log","$routeParams"],angular.module("shared").service("paginationService",e)}(),function(){"use strict";function e(e,t){this.forms=function(r,n){var a=e.open({ariaLabelledBy:"modal-title",ariaDescribedBy:"modal-body",templateUrl:"parts/popups/form.html",controller:["$uibModalInstance","items",function(e,t){var r=this,n={};r.title=t.title,r.fields=t.fields,r.validationCustom=function(e){var t=!0;n.filled=!0;for(var a=0;a<r.fields.length;a+=1){var i=r.fields[a];n[i.name]=i.text}return n.confirm_password?n.password===n.confirm_password&&e.$valid&&(t=!1):t=!e.$valid,t},r.send=function(t){e.close(t)},r.cancel=function(){e.dismiss("cancel")}}],controllerAs:"$ctrl",size:"md",resolve:{items:function(){return r}}});a.result.then(function(e){n(e)},function(){t.info("Modal dismissed at: "+new Date)})},this.messages=function(t,r){e.open({ariaLabelledBy:"modal-title",ariaDescribedBy:"modal-body",templateUrl:"parts/popups/messages.html",controller:["$uibModalInstance","options",function(e,r){var n=this;n.title=_.capitalize(t),n.data=r.data.message,n.classes=t,n.close=function(){e.dismiss("cancel")}}],controllerAs:"$ctrl",size:"md",resolve:{options:function(){return r}}})}}e.$inject=["$uibModal","$log"],angular.module("shared").service("popupsService",e)}(),function(){"use strict";function e(e){}e.$inject=["$log"],angular.module("users").service("usersService",e)}();